...
@section('contenu')
          <div class="banner">
            <svg
              class="section-banner_leftLines draw-appcomLines blue-lines"
              data-animated
              width="331"
              height="321"
              viewBox="0 0 331 321"
            ...
            <svg
              class="section-banner_rightLines draw-appcomLines blue-lines"
              data-animated
              width="331"
              height="321"
              viewBox="0 0 331 321"
            ...
            <div class="banner-content">
              <h1 class="title-big bold" data-aos="fade-up" data-aos-duration="650" data-aos-delay="300">
                Catalyseur de votre succès numérique<span class="blue">.</span>
              </h1>
              <p class="sub-title" data-aos="fade-up" data-aos-duration="650" data-aos-delay="400">
                Située dans la région de Kinshasa, <strong>DigiLife</strong> est
                un studio spécialisé dans le développement d'applications
                mobiles et Web.
              </p>
            </div>

            <div class="animated-arrow">
              <a href="#numeric-ecosystem-section">
                <img src="{{asset('assets/img/svg/arrow-down-icon.svg')}}" alt="" loading="lazy" />
              </a>
            </div>
          </div>

          <section class="section" id="numeric-ecosystem-section">
            <div class="container">
              <div class="home-computers-image" data-aos="zoom-in-left" data-aos-duration="650" data-aos-delay="50">
                <img
                  class="cover"
                  src="{{asset('assets/img/home-illustration-04-2x.png')}}"
                  srcset="{{asset('
                    assets/img/home-illustration-04.png     851w')}}
                  "
                    {{-- img/home-illustration-04-2x.png 1702w --}}
                  sizes="(max-width:768px) 851px, 1702px"
                  alt="Image créateurs de produits et d&#039;écosystèmes numériques mobiles et Web."
                  loading="lazy"
                />
              </div>

              <div class="box-link content-center" data-aos="zoom-in-right" data-aos-duration="650" data-aos-delay="50">
                <img
                  src="{{asset('assets/img/digilife-logo.png')}}"
                  alt="Image logo DigiLife"
                  class="mb-3"
                />
                <h2>
                  Créateur de produits et
                  <span class="blue">d'écosystèmes numériques</span> mobile et
                  web
                </h2>
                <p>
                  Fort de notre expérience et de notre esprit de collaboration,
                  nous réinventons vos solutions technologiques pour les arrimer
                  parfaitement à votre réalité. Notre approche centrée sur le
                  design repose sur deux objectifs : la qualité des produits et
                  le succès de vos utilisateurs.
                </p>
                <a href="{{Route('approche')}}" class="btn-core"
                  >Découvrir notre approche</a
                >
              </div>
            </div>
          </section>

          <section class="section expertise mx-0 w-100">
            <div class="container">
              <div class="mb-4 text-center">
                <h2 class="title" data-aos="fade-up" data-aos-duration="650" data-aos-delay="50">
                  <span class="bold">Nos expertises</span> livrent du concret
                </h2>
              </div>
              <div class="expertise-nav">
                <div class="expertise-link app-mobile active" data-aos="fade-up" data-aos-duration="650" data-aos-delay="150">
                  Application mobile
                </div>
                <div class="expertise-link app-web" data-aos="fade-up" data-aos-duration="650" data-aos-delay="250">Application web</div>
                <div class="expertise-link ui" data-aos="fade-up" data-aos-duration="650" data-aos-delay="350">Interface Utilisateur</div>
                <div class="expertise-link ux" data-aos="fade-up" data-aos-duration="650" data-aos-delay="450">Expérience Utilisateur</div>
              </div>

              <div class="expertise-content" data-aos="fade-up" data-aos-duration="650" data-aos-delay="150">
                <div class="app-mobile active">
                  <h2>Développement d'applications mobiles.</h2>
                  <p>
                    Nous développons des applications mobiles natives pour les
                    téléphones et tablettes qui répondent aux critères de
                ...
                <div class="app-web">
                  ...
                  <p>
                    Nous développons des applications web accessibles et
                    sécurisées offrant des interfaces qui s'adaptent à la
                    réalité des usagers.
                  </p>
                </div>
                <div class="ui">
                  <h2>Disign d'interface utilisateur.</h2>
                  <p>
                    Nous imaginons des interfaces qui reflètent votre identité
                    visuelle et qui génèrent un engagement accru.
                  </p>
                </div>
                <div class="ux">
                  <h2>Disign d'expérience utilisateur.</h2>
                  <p>
                    Nous créons des expériences utilisateurs riches qui guident
                    vos publics cibles vers ce qu'ils recherchent.
                  </p>
                </div>
              </div>

              <div class="mb-3 text-center" data-aos="fade-up" data-aos-duration="650" data-aos-delay="50">
                <a href="{{Route('expertise.create')}}" class="btn-core-white"
                  >Voir toutes nos expertises</a
                >
              </div>
            </div>
          </section>
          ...
          <section class="section mx-0">
            <div class="container">
              <div class="content-center mb-5">
                <h2 class="title text-center" data-aos="zoom-in-up" data-aos-duration="650" data-aos-delay="50">
                  Fiers de créer des
                  <span class="bold">projets novateurs</span> qui font une
                  différence.
                </h2>
              </div>

              <div class="row" data-aos="fade-up" data-aos-duration="650" data-aos-delay="50">
                @foreach ($realisations as $realisation)
                <div class="col-12 col-sm-6 col-md-4">
                  <div class="project-preview-box">
                    <img
                      src="{{ asset('assets/img/'.$realisation->image) }}"
                      alt=""
                      class="cover"
                    />
                    <div class="project-title">{{$realisation->titre}}</div>
                    <div class="project-button">
                      <a class="btn-core" href="/realisation-detail/{{$realisation->id}}"
                        >Voir détails</a
                      >
                    </div>
                  </div>
              ...
              <div class="content-center text-center mt-5" data-aos="fade-up" data-aos-duration="650" data-aos-delay="50">
                <a href="{{Route('realisation.create')}}" class="btn-core"
                  >Voir toutes nos realisations</a
                >
              </div>
            </div>
          </section>
          ...
          <section class="section mx-0">
            <div class="container">
              <div class="content-center mb-5">
                <h2 class="title text-center" data-aos="zoom-in-up" data-aos-duration="650" data-aos-delay="50">
                  A la recherche de <span class="bold">passionnés</span> du
                  numérique.
                </h2>
              </div>
              ...
              <div class="row align-items-start">
                <div class="col-12 col-md-6 p-0">
                  <div class="core-img">
                    <img
                      src="{{asset('assets/img/academy-student-programmer-3.jpg')}}"
                      alt=""
                      class="cover"
                    />
                  </div>
          ...
          <section class="section mx-0 news">
            <div class="container">
              <div class="content-center mb-5">
                <h2 class="title text-center" data-aos="zoom-in-left" data-aos-duration="650" data-aos-delay="50">
                  Les nouvelles de <span class="bold">DigiLife.</span>
                </h2>
              </div>

              <div class="row" data-aos="zoom-in-right" data-aos-duration="650" data-aos-delay="50">
               @foreach ($newss as $news)
                <div class="col-12 col-sm-6 col-md-4">
                  <div class="project-preview-box">
                    <img
                      src="{{ asset('assets/img/'.$news->image) }}"
                      alt=""
                      class="cover"
                    />
                    ...
                    <div class="project-button">
                      <a class="btn-core" href="/news-detail/{{$news->id}}"
                        >Voir détails</a
                      >
                    </div>
                  </div>
              ...
              <div class="content-center text-center mt-5" data-aos="fade-up" data-aos-duration="650" data-aos-delay="50">
                <a href="{{('news.create')}}" class="btn-core"
                  >Voir toutes nos nouvelles</a
                >
              </div>
            </div>
          </section>
          @include('layout.partials.cookies.cookies')
@endsection